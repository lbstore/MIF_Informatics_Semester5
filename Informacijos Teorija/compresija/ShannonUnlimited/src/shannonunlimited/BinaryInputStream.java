...
public final class BinaryInputStream {
    ...
    private int N;                 // number of bits left in buffe

    public BinaryInputStream(String pathToFile) throws IOException { 
        in = new BufferedInputStream(Files.newInputStream(Paths.get(pathToFile)));
        fillBuffer();
    }
